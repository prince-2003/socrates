...
export default function Pricing() {
  ...
  return (
    <div id="pricing" className="w-[96vw] m-2 rounded-xl  p-10 md:p-20 bg-black inline-flex flex-col gap-10 md:gap-20 relative ">
      ...
      <div className="mx-auto justify-center grid-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {tiers.map((tier) => (
          <div
            key={tier.id}
